 <?php
	...
	*/ 
	...
	echo "<div class='header'>";
		echo "<h4 style='margin-left:10px;'>Listing all EGL extensions ($sqlCount)</h4>";
	echo "</div>";			
?>
		...
		<?php		
			...
			while ($row = mysql_fetch_row($sqlresult))
            {
				...
				if (!empty($extname)) 
                {
					...
					echo "<tr>";						
					echo "<td class='firstcolumn'><a href='gles_listreports.php?eglextension=".$extname."'>".$extname."</a> (<a href='gles_listreports.php?eglextensionunsupported=".$extname."'>not</a>) </td>";					
