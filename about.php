	...
	<div class="panel panel-default">
		<div class="panel-body" style="margin-left:50px; width:65%px;">    
			...
			<div>
				...
				If you want to contribute to the development, you can find the source code at <a href="https://github.com/SaschaWillems/glESCapsViewerWeb" target="_blank">https://github.com/SaschaWillems/glESCapsViewerWeb</a>.
			</div>
			<h2>Donating</h2>
			<div>
